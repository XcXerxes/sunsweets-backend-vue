<template>
    <Form :model="carouselForm" :rules="rules" ref="carForm" :label-width="120">
        ...
        <Form-item label="上传轮播图：" prop="img">
            <Upload ref="upload" :show-upload-list="false" :on-success="handleSuccess" :format="['jpg','jpeg','png','gif']" 
                :max-size="500" :on-format-error="handleFormatError" 
                ...
                <img class="carousel-uploader__img" v-else :src="carouselForm.img" alt="">
            </Upload>
        </Form-item>
        <Form-item>
            <Row>
